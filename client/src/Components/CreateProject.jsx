...
const CreateProject = ({ onClose, onSuccess }) => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            // Dispatch action to create project and update Redux
            await dispatch(addProjectAction(data));
            ...
            const errorMessage = err.response?.data?.error || err.message || 'שגיאה ביצירת הפרויקט';
